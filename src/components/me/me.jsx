  ...
  <Main>
    ...
    <div className="areaTexto">
      <p className="sobre">
        ...
        técnica em informática pela escola Dr. Solon Tavares e atualmente estou
        cursando o terceiro semestre do Bacharelado em Ciência da Computação na
        Faculdade de Desenvolvimento do Rio Grande do Sul (FADERGS). Desenvolvo
        diversos projetos em JavaScript, CSS, HTML e Java utilizando como
        ferramentas o React, Angular e Vue, a fim de aprimorar minhas
        habilidades e conhecimentos. Busco uma oportunidade como desenvolvedor
        Front-End, embora também possa atuar na área de Back-End.
      </p>
    </div>
  </Main>
)
